...
This is the proceedure for deploying a new version of a CESSDA Core  {% include glossary.html entry="product" %} (one of CDC, CVS, EQB, ELSST) to the production environmemt.
