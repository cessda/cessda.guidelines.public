...
Development of CESSDA tools and services is carried out using CESSDA-owned Git repositories hosted on GitHub.

If the code is developed publicly elsewhere, the source code is mirrored with clear pointers present in the repository description to the upstream source.

All software development should follow common best practices for the tools and languages used. Additionally, the recommendations of the
